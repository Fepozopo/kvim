...
-- Copilot AI keymaps
vim.keymap.set('n', '<leader>ct', ':Copilot toggle<CR>', { desc = '[C]opilot [T]oggle Buffer Status' })
vim.keymap.set('n', '<leader>cs', ':Copilot status<CR>', { desc = '[C]opilot [S]tatus' })
vim.keymap.set('n', '<leader>cl', ':Copilot model list<CR>', { desc = '[C]opilot [L]ist Models' })
vim.keymap.set('n', '<leader>cp', ':Copilot panel<CR>', { desc = '[C]opilot [P]anel' })
vim.keymap.set('n', '<leader>ca', ':Copilot suggestion toggle_auto_trigger<CR>', { desc = '[C]opilot Toggle [A]uto Trigger' })
...
-- Make tabs
vim.api.nvim_set_keymap('n', '<leader>mn', ':tabnew<CR>:Oil<CR>', { noremap = true, silent = true, desc = '[M]ake [N]ew Tab' })

-- Insert new line without entering insert mode and remain on current line
-- Supports count to insert multiple lines
...
end, { remap = false, silent = true, desc = 'Insert new line(s) below without entering insert mode' })
...
end, { remap = false, silent = true, desc = 'Insert new line(s) above without entering insert mode' })
